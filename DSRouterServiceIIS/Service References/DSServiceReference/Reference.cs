...
namespace DSRouterServiceIIS.DSServiceReference {
    ...
    public enum EnumerationCommandStates : int {
        ...
        [System.Runtime.Serialization.EnumMemberAttribute()]
        cmdCancelAtRouterByTimer = 7,
        
        [System.Runtime.Serialization.EnumMemberAttribute()]
        cmdDiscardByDataServer = 8,
        
        [System.Runtime.Serialization.EnumMemberAttribute()]
        cmdDiscardByRouter = 9,
    }
    ...
    public interface IWcfDataServer {
        ...
        bool EndCommandRun(System.IAsyncResult result);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWcfDataServer/CommandCancel", ReplyAction="http://tempuri.org/IWcfDataServer/CommandCancelResponse")]
        void CommandCancel(string ACommandID);
        
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IWcfDataServer/CommandCancel", ReplyAction="http://tempuri.org/IWcfDataServer/CommandCancelResponse")]
        System.IAsyncResult BeginCommandCancel(string ACommandID, System.AsyncCallback callback, object asyncState);
        
        void EndCommandCancel(System.IAsyncResult result);
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CommandRunCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        public CommandRunCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    public partial class WcfDataServerClient : System.ServiceModel.DuplexClientBase<DSRouterServiceIIS.DSServiceReference.IWcfDataServer>, DSRouterServiceIIS.DSServiceReference.IWcfDataServer {
        ...
        private BeginOperationDelegate onBeginCommandCancelDelegate;
        
        private EndOperationDelegate onEndCommandCancelDelegate;
        
        private System.Threading.SendOrPostCallback onCommandCancelCompletedDelegate;
        ...
        public event System.EventHandler<CommandRunCompletedEventArgs> CommandRunCompleted;
        
        public event System.EventHandler<System.ComponentModel.AsyncCompletedEventArgs> CommandCancelCompleted;
        ...
        public bool CommandRun(string ACommandID, object[] AParameters) {
            return base.Channel.CommandRun(ACommandID, AParameters);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public bool EndCommandRun(System.IAsyncResult result) {
            return base.Channel.EndCommandRun(result);
        }
        ...
        private object[] OnEndCommandRun(System.IAsyncResult result) {
            bool retVal = this.EndCommandRun(result);
            return new object[] {
                    retVal};
        }
        ...
        private void OnCommandRunCompleted(object state) {
            if ((this.CommandRunCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.CommandRunCompleted(this, new CommandRunCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }
        ...
        public void CommandCancel(string ACommandID) {
            base.Channel.CommandCancel(ACommandID);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public System.IAsyncResult BeginCommandCancel(string ACommandID, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginCommandCancel(ACommandID, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public void EndCommandCancel(System.IAsyncResult result) {
            base.Channel.EndCommandCancel(result);
        }
        
        private System.IAsyncResult OnBeginCommandCancel(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string ACommandID = ((string)(inValues[0]));
            return this.BeginCommandCancel(ACommandID, callback, asyncState);
        }
        
        private object[] OnEndCommandCancel(System.IAsyncResult result) {
            this.EndCommandCancel(result);
            return null;
        }
        
        private void OnCommandCancelCompleted(object state) {
            if ((this.CommandCancelCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.CommandCancelCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void CommandCancelAsync(string ACommandID) {
            this.CommandCancelAsync(ACommandID, null);
        }
        
        public void CommandCancelAsync(string ACommandID, object userState) {
            if ((this.onBeginCommandCancelDelegate == null)) {
                this.onBeginCommandCancelDelegate = new BeginOperationDelegate(this.OnBeginCommandCancel);
            }
            if ((this.onEndCommandCancelDelegate == null)) {
                this.onEndCommandCancelDelegate = new EndOperationDelegate(this.OnEndCommandCancel);
            }
            if ((this.onCommandCancelCompletedDelegate == null)) {
                this.onCommandCancelCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnCommandCancelCompleted);
            }
            base.InvokeAsync(this.onBeginCommandCancelDelegate, new object[] {
                        ACommandID}, this.onEndCommandCancelDelegate, this.onCommandCancelCompletedDelegate, userState);
        }
